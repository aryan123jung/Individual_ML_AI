...
# ─── CONFIG ──────────────────────────────────────────────────────────────────
DATA_FOLDER = "data/raw/Syed_Mushtaq_Ali_Trophy_Raw"
...
def parse_all_matches(data_folder):
    ...
    print(f"Processing {len(all_files)} match files...")
    ...
    print("Done parsing all matches!")
...
if __name__ == "__main__":
    ...
    # Save raw match-level records
    batting_df.to_csv(f"{OUTPUT_FOLDER}/smat_batting_raw.csv", index=False)
    bowling_df.to_csv(f"{OUTPUT_FOLDER}/smat_bowling_raw.csv", index=False)
